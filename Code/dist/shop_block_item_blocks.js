 ...
 */
export function construct_shop_block_item_block_ring(game_state) {
    const ring_cost = 0;
 ...
 */
export function construct_shop_block_item_block_test_trap(game_state, i) {
 ...
 * @param i the index in the shop menu that the item has
 */
export function construct_shop_block_item_block_lvl_1_trap(game_state, i) {
 ...
 */
export function construct_shop_block_item_block_dagger(game_state, i) {
    const dagger_cost = 2;
