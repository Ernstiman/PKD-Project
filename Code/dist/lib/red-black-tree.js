 ...
 */
export function left_branch(node) {
    return node[3];
}
/**
 ...
 */
export function right_branch(node) {
    return node[4];
}
/**
 ...
 */
export function make_empty_tree() {
    return null;
}
/**
 ...
 */
export function is_empty_tree(tree) {
    return tree === null;
}
 ...
 */
export function deep_equals(tree1, tree2) {
 ...
 */
export function insert(tree, new_key, new_value) {
 ...
 */
export function build_tree(elements) {
 ...
 */
export function get_all_keys(tree) {
    return is_empty_tree(tree)
        ? list()
        : append(append(get_all_keys(left_branch(tree)), list(key(tree))), get_all_keys(right_branch(tree)));
}
/**
 * Returns the in-sorted values of a tree.
 * @template T type of data stored in the red-black tree
 ...
 * @returns Returns a list of values from the tree following an in-order traversal.
 */
export function get_all_values(tree) {
    return is_empty_tree(tree)
        ? list()
        : append(append(get_all_values(left_branch(tree)), list(value(tree))), get_all_values(right_branch(tree)));
}
/**
 ...
 */
export function display_tree(tree) {
