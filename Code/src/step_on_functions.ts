...
function generate_shop_items(game_state: GameState): void{
    ...
    const number_of_shop_items: number = 3;
 ...
 */
export function shop_step_on(game_state: GameState, node: iNode, node_object: NodeObject){
    // Empty the shop
    console.log("hej")
 ...
 */
export function wolf_step_on(game_state: GameState, node: iNode, node_object: NodeObject): void{
    let i=0
